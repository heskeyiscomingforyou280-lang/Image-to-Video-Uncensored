...
pipe.load_lora_weights(
    "heskeyiscoming/fingering",
    weight_name="fingering_orgasm_000000200_high_noise.safetensors",
...
pipe.load_lora_weights(
    "heskeyiscoming/pussyanushelper",
    weight_name="wan2.2_i2v_low_ulitmate.safetensors",
