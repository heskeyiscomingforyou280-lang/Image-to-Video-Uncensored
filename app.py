...
pipe.load_lora_weights(
    "heskeyiscoming/multi",
    weight_name="W22_Multiscene_Photoshoot_Softcore_i2v_HN.safetensors",
...
pipe.load_lora_weights(
    "heskeyiscoming/multi",
    weight_name="W22_Multiscene_Photoshoot_Softcore_i2v_LN.safetensors",
