...
pipe.load_lora_weights(
    "heskeyiscoming/cowgirl2",
    weight_name="Make_em_frontrevcowgrl_high_noise_wan2.2_14b_i2v.safetensors",
...
pipe.load_lora_weights(
    "heskeyiscoming/cowgirl2",
    weight_name="Make_em_frontrevcowgrl_low_noise_wan2.2_14b_i2v.safetensors",
